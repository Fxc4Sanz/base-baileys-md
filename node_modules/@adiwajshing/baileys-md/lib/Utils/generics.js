...
const encodeWAMessage = (message) => (Buffer.from((0, exports.writeRandomPadMax16)(new WABinary_1.Binary(WAProto_1.proto.Message.encode(message).finish())).readByteArray()));
exports.encodeWAMessage = encodeWAMessage;
const generateRegistrationId = () => (Uint16Array.from((0, crypto_1.randomBytes)(2))[0] & 0x3fff);
...
async function promiseTimeout(ms, promise) {
    ...
    let { delay, cancel } = (0, exports.delayCancellable)(ms);
